...
mod tests {
    ...
    fn closed_market_lets_traders_out_but_not_in() {
        ...
        assert_eq!(
            ...
            Err(ArclisError::CannotIncreaseRiskWhileClosed)
        );
    }
    ...
    fn preopen_has_no_firm_price_so_blocks_everything() {
        assert_eq!(
            ...
            Err(ArclisError::SessionNotOpen)
        );
        assert_eq!(
