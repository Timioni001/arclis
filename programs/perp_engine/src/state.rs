...
/// Keeper-fed price account a market's oracle authority pushes updates to.
/// Production hardening note (see README): swap this for a real Pyth/
/// Switchboard feed once the Solana toolchain's bundled Rust supports the
/// crypto-verification dependencies those SDKs currently require.
#[account]
