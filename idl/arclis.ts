 ...
 */
export type Arclis = {
  "address": "8KwHVevdqvNrwTCgsTvwQzvWXNsdonHKCi9mrH6gN23x",
  "metadata": {
    "name": "arclis",
    "version": "0.1.0",
    "spec": "0.1.0",
    "description": "General-purpose oracle-priced perpetuals engine for tokenized stocks on Solana"
  },
  "instructions": [
    {
    ...
    {
      "name": "request_withdraw_liquidity",
      "docs": [
    ...
    {
      "name": "cancel_withdraw_liquidity",
      "discriminator": [
        68,
        64,
        226,
    ...
    },
    {
      ...
      "args": [
        {
          "name": "hedge_ratio_bps",
          "type": "u16"
        },
        {
          "name": "rebalance_tolerance_bps",
          "type": "u16"
        }
      ]
    },
    {
      "name": "set_treasury_policy",
      "discriminator": [
        255,
        232,
        110,
  ...
  "errors": [
    ...
    {
      "code": 6010,
      "name": "CannotIncreaseRiskWhileClosed",
      "msg": "Cannot increase risk while the underlying venue is closed; you can still reduce or close"
    },
    {
      "code": 6011,
      "name": "NotOracleAuthority",
    ...
    },
    {
      ...
      "type": {
        "fields": [
          ...
          {
            "name": "split_factor_before",
            "type": "u64"
          },
          {
            "name": "split_factor_after",
            "type": "u64"
          },
          {
            "name": "price_before",
    ...
    },
    {
      ...
      "type": {
        ...
        "fields": [
          ...
          {
            "name": "funding_interval_secs",
            "type": "i64"
          },
          {
            "name": "last_funding_ts",
            "type": "i64"
          },
          {
            "name": "cumulative_funding_index",
            "docs": [
      ...
      "type": {
        "fields": [
          ...
          },
          {
            ...
            "name": "bad_debt_absorbed_by_pool",
            "type": "u64"
          },
          {
            "docs": [
